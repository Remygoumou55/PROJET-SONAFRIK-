...
const styles = StyleSheet.create({
  ...
  hero: {
    ...
    padding: 16,
    borderWidth: 1,
    borderColor: "rgba(0, 210, 106, 0.20)",
  },
  heroVisual: {
    width: 60,
    height: 60,
  ...
  heroInfo: { flex: 1 },
  heroLabel: { color: "rgba(255, 255, 255, 0.60)", fontSize: 11, fontWeight: "600", textTransform: "uppercase", letterSpacing: 0.5, marginBottom: 4 },
  heroTitle: { color: colors.textePrincipal, fontSize: 17, fontWeight: "700", marginBottom: 3 },
  heroArtist: { color: "rgba(255, 255, 255, 0.80)", fontSize: 13, marginBottom: 4 },
  heroStats: { color: "rgba(255, 255, 255, 0.53)", fontSize: 12 },
  ...
  trackCoverActive: { backgroundColor: "rgba(0, 210, 106, 0.13)", borderColor: colors.vertEnergie, borderWidth: 1.5 },
  ...
  newCoverActive: { backgroundColor: "rgba(0, 210, 106, 0.13)", borderColor: colors.vertEnergie, borderWidth: 1.5 },
