    ...
    <div className="max-w-2xl mx-auto px-4 py-8 space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex-1 space-y-2">
          <div className="h-4 w-40 rounded-lg animate-pulse" style={{ backgroundColor: "var(--color-card)" }} />
          <div className="h-3 w-24 rounded-lg animate-pulse" style={{ backgroundColor: "var(--color-card)" }} />
        </div>
      </div>
      {/* Cards */}
      {[...Array(4)].map((_, i) => (
