  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div className="h-4 w-40 rounded animate-pulse" style={{ backgroundColor: "var(--color-card)" }} />
        <div className="h-8 w-24 rounded-lg animate-pulse" style={{ backgroundColor: "var(--color-card)" }} />
      </div>
      {[...Array(2)].map((_, i) => (
        <div
          key={i}
        ...
        >
          ...
          <div className="h-5 w-5 rounded" style={{ backgroundColor: "var(--color-elevated)" }} />
        </div>
      ))}
      <div className="h-px w-full" style={{ backgroundColor: "var(--color-card)" }} />
      <div className="h-4 w-44 rounded animate-pulse" style={{ backgroundColor: "var(--color-card)" }} />
      {[...Array(3)].map((_, i) => (
        <div
          key={i}
          className="flex items-center justify-between rounded-xl p-4 animate-pulse"
