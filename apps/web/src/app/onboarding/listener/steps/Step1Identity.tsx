...
export function Step1Identity({ wizard }: Props) {
  const canContinue = wizard.data.fullName.trim().length > 0

  return (
    <OnboardingStepWrapper
      title="Qui êtes-vous ?"
      subtitle="Votre nom tel qu'il apparaîtra sur votre profil."
      showBack={false}
    >
      <div style={{ display: 'flex', flexDirection: 'column', gap: '18px' }}>
        <div>
          ...
          <input
            ...
            onChange={(e) => wizard.updateData({ fullName: e.target.value })}
