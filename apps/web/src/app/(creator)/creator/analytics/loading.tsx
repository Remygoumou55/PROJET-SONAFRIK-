export default function AnalyticsLoading() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-8 space-y-6">
      ...
      {/* Chart skeleton */}
      <div className="h-48 w-full rounded-2xl animate-pulse" style={{ backgroundColor: "var(--color-card)", animationDelay: "200ms" }} />
      {/* Row list */}
        ...
        {[...Array(5)].map((_, i) => (
          ...
          >
            ...
            <div className="flex-1 space-y-1.5">
              <div className="h-3 w-2/3 rounded" style={{ backgroundColor: "var(--color-card)" }} />
              <div className="h-2.5 w-1/3 rounded" style={{ backgroundColor: "var(--color-card)" }} />
            </div>
            <div className="h-4 w-12 rounded" style={{ backgroundColor: "var(--color-card)" }} />
          </div>
        ))}
      </div>
    </div>
