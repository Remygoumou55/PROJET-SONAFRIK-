  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-8 space-y-4">
      <div className="flex items-center justify-between mb-6">
        <div className="h-6 w-24 rounded-xl animate-pulse" style={{ backgroundColor: "#1F1F1F" }} />
      ...
      {[...Array(3)].map((_, i) => (
        ...
        >
          ...
          <div className="flex-1 space-y-2">
            <div className="h-4 w-36 rounded" style={{ backgroundColor: "#1F1F1F" }} />
            <div className="h-3 w-20 rounded" style={{ backgroundColor: "#1F1F1F" }} />
          </div>
          <div className="h-7 w-16 rounded-lg" style={{ backgroundColor: "#1F1F1F" }} />
        </div>
      ))}
    </div>
  );
