      ...
      <Card>
        <CardContent className="py-4">
          <form onSubmit={createRelease} className="space-y-3">
            <p className="text-[var(--t8-silver)] text-xs">
        ...
        <Card key={album.id}>
          <CardContent className="space-y-3 py-4">
            <div className="flex flex-wrap items-center gap-2">
              <p className="text-[var(--t8-pearl)] font-semibold">{album.title}</p>
            ...
            {album.upc ? <p className="text-[var(--t8-silver-deep)] text-xs">UPC · {album.upc}</p> : null}
