export function LandingTransparencyNote() {
  return (
    ...
    >
      <span style={{ fontSize: "20px", color: "#00D26A", flexShrink: 0, lineHeight: 1 }}>ℹ</span>
      <div>
        <p style={{ fontSize: "14px", fontWeight: 600, color: "#ffffff", margin: "0 0 8px" }}>
        ...
        >
          Sur chaque abonnement, <strong style={{ color: "#ffffff" }}>65 %</strong> sont partagés
          ...
          <strong style={{ color: "#ffffff" }}>65 %</strong>.
          <br />
