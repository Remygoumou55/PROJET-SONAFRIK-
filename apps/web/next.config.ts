...
const scriptSrc = isProd ? `'self' 'nonce-__NONCE__' 'strict-dynamic' 'unsafe-inline' https://${supabaseHostname} https://vitals.vercel-insights.com` : `'self' 'nonce-__NONCE__' 'strict-dynamic' 'unsafe-eval' 'unsafe-inline' https://${supabaseHostname} https://vitals.vercel-insights.com`;
