-- Perf Admin 2 — batch stats pour listes users/artistes (évite N+1)
...
GRANT EXECUTE ON FUNCTION public.admin_batch_user_list_stats(UUID[]) TO authenticated;
GRANT EXECUTE ON FUNCTION public.admin_batch_creator_catalog_stats(UUID[]) TO authenticated;
